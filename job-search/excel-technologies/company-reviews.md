...
- Sản phẩm nổi bật (xác nhận qua Google Play + giải thưởng):
  - **Wisere — đã xác nhận rõ, là nền tảng 2 chiều (2-sided marketplace), không phải 1 app đơn:**
    - App **"Wisere"** (Google Play `vn.exceltech.wisere`, App Store id6479496732) — app cho **người dùng cuối**: tìm cơ sở dịch vụ gần đó (cắt tóc, nail, spa, nha khoa) theo vị trí, đặt lịch, có voucher/ưu đãi riêng.
    - App **"Wisere Manager"** (Google Play `com.exceltech.wisere_mobile_app`) — app cho **chủ cơ sở/nhà cung cấp dịch vụ**: quản lý lịch hẹn, hồ sơ khách, vật liệu, nhân sự.
    - Bản web wisere.com mô tả nghiêng về phần quản lý vận hành (B2B/SaaS) — khớp với mặt "Manager" của nền tảng.
    - → Kết luận: Wisere là mô hình giống Booksy/Grab nhưng cho ngành làm đẹp + y tế VN — 1 bên marketplace tìm/đặt lịch cho người dùng, 1 bên SaaS quản trị vận hành cho chủ cơ sở. Giải Sao Khuê 2023. Developer xác nhận: **Excel Technologies JSC**, email hỗ trợ `support.et@exceltech.vn`, địa chỉ đăng ký 805 C/C 354/15B Lý Thường Kiệt, P.14, Q.10, TP.HCM (khác với 2 địa chỉ trụ sở/văn phòng ghi trong JD — có thể là địa chỉ đăng ký kinh doanh cũ, không phải văn phòng làm việc hiện tại, không quan trọng để hỏi).
